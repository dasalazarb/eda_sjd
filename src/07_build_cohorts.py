...
def main() -> None:
    ...
    sheets = {}
    sheets.update(build_targeted_eda_sheets(baseline, "07_cohort_baseline_output", "07_cohort_baseline_output"))
    sheets.update(
        build_targeted_eda_sheets(longitudinal, "07_cohort_longitudinal_output", "07_cohort_longitudinal_output")
    )
    sheets.update(
        build_targeted_eda_sheets(time_to_event, "07_cohort_time_to_event_output", "07_cohort_time_to_event_output")
    )
