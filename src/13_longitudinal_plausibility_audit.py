...
CODEBOOK_DOMAINS = {
    "clinical_disease_evaluation": {
        ...
        "sjogren's_syndrome_history": 29,
        "sjogren's_syndrome_disease_damage_index": 15,
    ...
    "imaging_and_biopsy": {
        "biopsy_pathology": 23,
        "sg-us_grading_scale:_theander_&_mandl_(2014)": 12,
        "sgus_grading_scale:_jousse-joulin_(2017)": 45,
        "sgus_grading_scale:_omeract_(2021)": 10,
        "scintigraphy_(technetium_scan)": 9,
        "ultrasound": 2,
        "mucosal_biopsy": 2,
        "skin_biopsy": 3,
        "buccal_swab_form": 3,
    ...
    "specimens_and_procedures": {
        "adverse_events": 303,
        "oral_rinse/plaque_collection": 4,
        "oral_rinse": 1,
        "plaque_collection": 2,
    ...
    "administrative_and_protocol": {
        ...
        "vital_signs": 9,
        "inclusion/exclusion_checklist": 5,
        "inclusion/exclusion_criteria": 9,
